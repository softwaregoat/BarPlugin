...
include_once('ContentPoweredCallToAction_OptionsManager.php');

class ContentPoweredCallToAction_InstallIndicator extends ContentPoweredCallToAction_OptionsManager {
