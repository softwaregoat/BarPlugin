...
include_once('ContentPoweredCallToAction_InstallIndicator.php');

class ContentPoweredCallToAction_LifeCycle extends ContentPoweredCallToAction_InstallIndicator {
